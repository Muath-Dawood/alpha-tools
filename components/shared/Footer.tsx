...
const Footer = () => {
  ...
  return (
    <footer className="mt-32 w-full max-w-[1400px] bg-secondary-background text-gray-400 px-5 pb-5 pt-12">
      ...
      <div className="mt-10 w-full">
        <div className="flex-center w-full flex-col gap-11 lg:flex-row">
          ...
          <div className="flex-center flex-wrap items-start justify-start gap-6 md:gap-14 [&>div>span]:font-bold [&>div>span]:text-primary-background [&>div]:font-medium">
            ...
            <div className="flex-center flex-col mt-10 items-start gap-4 [&>a:active]:text-primary-background sm:[&>a:focus]:text-secondary-foreground sm:[&>a:hover]:text-secondary-foreground [&>a]:transition-all [&>a]:duration-300">
              <Link href={"/#benefits of treatment"}>
                {translation("benefits of treatment")}
              </Link>
              <Link href={"/#Frequently Asked Questions"}>
        ...
        <div className="mx-auto mb-6 mt-10 h-[0.125rem] w-full max-w-[71.875rem] rounded-full bg-gray-500"></div>
